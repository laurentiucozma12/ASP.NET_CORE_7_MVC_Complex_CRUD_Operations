        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackpackId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterFaction", x => new { x.CharacterId, x.FactionId });
                    table.ForeignKey(
                        name: "FK_CharacterFaction_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CharacterFaction_Factions_FactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterFaction_FactionId",
