    ...
    public class CharactersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Characters != null ? 
                          ...
                          Problem("Entity set 'DataContext.Characters'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BackpackId")] Character character)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BackpackId")] Character character)
        {
            if (id != character.Id)
            {
                return NotFound();
